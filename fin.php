    ...
    <div class="bg-black text-white py-2 text-xs md:text-sm font-bold tracking-widest border-b border-gray-800">
        <div class="marquee-container">
            <div class="marquee-content">
                 &nbsp;&nbsp;&nbsp; • &nbsp;&nbsp;&nbsp; 🚀 LATEST UPDATE: BIOMETRIC LOGIN ADDED &nbsp;&nbsp;&nbsp; • &nbsp;&nbsp;&nbsp; 🏆 RATED #1 GYM SOFTWARE IN PAKISTAN &nbsp;&nbsp;&nbsp; • &nbsp;&nbsp;&nbsp; 📞 24/7 SUPPORT AVAILABLE
            </div>
        </div>
    </div>
...
<div class="bg-white p-8 rounded-2xl shadow-lg border border-gray-100 hover:-translate-y-2 transition duration-300" data-aos="fade-up">
    <div class="w-14 h-14 bg-teal-100 rounded-2xl flex items-center justify-center mb-6">
        <i class="fas fa-boxes-stacked text-2xl text-teal-600"></i>
    </div>
    <h3 class="text-xl font-bold mb-3">Manage Inventory</h3>
    <p class="text-gray-500 text-sm leading-relaxed">Track supplements and gym gear stock. Get low-stock alerts and manage suppliers seamlessly.</p>
</div>
...
<div class="bg-white p-8 rounded-2xl shadow-lg border border-gray-100 hover:-translate-y-2 transition duration-300" data-aos="fade-up" data-aos-delay="100">
    ...
    <h3 class="text-xl font-bold mb-3">Manage Expenses</h3>
    <p class="text-gray-500 text-sm leading-relaxed">Keep a record of electricity bills, maintenance costs, and staff salaries to calculate net profit.</p>
</div>
...
<div class="bg-white p-8 rounded-2xl shadow-lg border border-gray-100 hover:-translate-y-2 transition duration-300" data-aos="fade-up" data-aos-delay="200">
    ...
    <h3 class="text-xl font-bold mb-3">Monthly Statistics</h3>
    <p class="text-gray-500 text-sm leading-relaxed">Visual graphs showing new admissions, revenue growth, and active members month-by-month.</p>
</div>
                <div class="bg-white p-8 rounded-2xl shadow-lg border border-gray-100 hover:-translate-y-2 transition duration-300" data-aos="fade-up">
                    ...
                    <h3 class="text-xl font-bold mb-3"> QR & Finger Print Attendence</h3>
                    <p class="text-gray-500 text-sm leading-relaxed">Membors can mark attendence by scanning the QR code by Mobile Apps and finger print device.</p>
                </div>
                ...
                <div class="bg-white p-8 rounded-2xl shadow-lg border border-gray-100 hover:-translate-y-2 transition duration-300" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <p class="text-gray-500 text-sm leading-relaxed">Fee Alers and reminders and reminder are auto send to the Members</p>
                </div>
    ...
    <section id="pricing" class="py-24 bg-white">
        <div class="container mx-auto px-6 text-center">
            ...
            <div class="mb-12" data-aos="fade-down">
                <h2 class="text-4xl font-bold mb-3">Pricing Plan</h2>
            ...
            <div class="max-w-4xl mx-auto" data-aos="zoom-in">
                <div class="bg-white rounded-3xl shadow-2xl border border-gray-100 overflow-hidden relative">
                    ...
                    <div class="p-8 md:p-14">
                        ...
                        <a href="https://wa.me/923147569736" target="_blank" class="inline-block btn-gradient font-bold text-xl px-12 py-5 rounded-full shadow-xl transform hover:-translate-y-1 transition duration-300 mb-8" id="sbbtn">
                            SUBSCRIBE NOW
                        </a>
                        <style>
...
<section class="py-24 bg-gray-50">
        <div class="container mx-auto px-6">
            ...
            <div class="text-center mb-16" data-aos="fade-down">
                <h2 class="text-4xl font-bold mb-4">Who Uses<span class="text-transparent bg-clip-text bg-gradient-to-r from-purple-500 to-pink-500">
    Fitness Force Pro?
  </span></h2>
  ...
  <section id="reviews" class="py-24 bg-gray-50 relative overflow-hidden">
    
    <div class="absolute top-0 left-0 w-full h-full overflow-hidden z-0 pointer-events-none">
        <div class="absolute top-20 left-0 w-96 h-96 bg-purple-200 rounded-full mix-blend-multiply filter blur-3xl opacity-30 animate-blob"></div>
        <div class="absolute bottom-20 right-0 w-96 h-96 bg-pink-200 rounded-full mix-blend-multiply filter blur-3xl opacity-30 animate-blob animation-delay-2000"></div>
    </div>
    ...
    <div class="container mx-auto px-6 relative z-10">
        ...
        <div class="text-center mb-20" data-aos="fade-down">
            ...
            <p class="mt-6 text-lg text-gray-500 max-w-2xl mx-auto">See what gym owners across the globe are saying about Fitness Force Pro.</p>
        </div>
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            if ($response && isset($response['data']) && !empty($response['data'])) {
                ...
                foreach ($reviews as $review) {
                    ...
                    <div class="h-full p-[2px] rounded-[2rem] bg-gradient-to-br from-purple-500 via-purple-400 to-pink-500 hover:shadow-[0_0_30px_rgba(168,85,247,0.4)] transition-all duration-300 hover:-translate-y-2" data-aos="fade-up" data-aos-delay="<?php echo $delay; ?>">
                        
                        <div class="bg-white rounded-[1.9rem] h-full p-8 flex flex-col relative overflow-hidden">
                            
                            <div class="flex items-center gap-4 mb-6 relative z-10">
                                
                                <div class="w-14 h-14 min-w-[3.5rem] rounded-full bg-purple-50 border-2 border-purple-100 flex items-center justify-center text-purple-600 text-2xl font-bold shadow-inner">
                                ...
                                <div class="flex flex-col">
                                    ...
                                    <span class="text-xs text-transparent bg-clip-text bg-gradient-to-r from-purple-500 to-pink-500 font-bold uppercase tracking-wider mt-1">
                                        <?php echo $gym; ?>
                                    </span>
                                </div>
                            </div>
                            ...
                            <div class="relative z-10">
                                <i class="fas fa-quote-right absolute -bottom-4 right-0 text-gray-50 text-6xl -z-10 opacity-50"></i>
                                
                                <p class="text-gray-600 leading-relaxed text-base font-light italic">
                                    "<?php echo $text; ?>"
                                </p>
                            </div>
                ...
                echo '<div class="col-span-3 text-center py-16">
                        <div class="inline-block w-12 h-12 border-4 border-gray-200 border-t-purple-500 rounded-full animate-spin mb-4"></div>
            ...
            <div class="flex flex-col lg:flex-row items-center gap-16">
                ...
                <div class="lg:w-1/2" data-aos="fade-right">
                    ...
                    <p class="text-gray-600 leading-relaxed mb-6 text-lg">
                        Fitness Force Pro started in the heart of <strong>Sargodha </strong> with a simple mission: to replace messy paper registers with smart technology.
                    </p>
                    <p class="text-gray-600 leading-relaxed mb-8 text-lg">
                        Today, we serve over <strong>500+ gyms across Globe</strong>. Our software is built by Professional developers And Engineers who understand the market needs, ensuring stability, ease of use, and 100% data security.
                    </p>
                </div>
    ...
    <section id="download-section" class="py-24 bg-gray-900 text-white relative overflow-hidden">
        ...
        <div class="container mx-auto px-6 text-center relative z-10">
            ...
            <p class="text-gray-400 text-lg mb-12 max-w-2xl mx-auto">
                Download the full <strong>Fitness Force  Pro Desktop Application</strong> for Windows.
            </p>
            ...
            <div class="bg-gray-800 inline-block p-10 rounded-3xl border border-gray-700 shadow-2xl mb-12 transform hover:scale-105 transition duration-500" data-aos="fade-up">
                <div class="flex items-center gap-6 mb-8 justify-center border-b border-gray-700 pb-6">
                    ...
                    <div class="text-left">
                        <div class="text-2xl font-bold text-white">Fitness Force Pro</div>
                        <div class="text-sm text-gray-400">For Windows 10 & 11 (64-bit)</div>
                    </div>
                </div>
                
              <a href="https://fitnessforcepro.com/Test/FitnessForceProSetup.exe" class="block btn-gradient text-xl font-bold px-12 py-5 rounded-full shadow-[0_0_20px_rgba(192,38,211,0.5)] mb-4" id="dnbtn">
    ...
    <footer class="bg-gray-900 text-white pt-20 pb-10 border-t border-blue-800">
        <div class="container mx-auto px-6">
            <div class="grid md:grid-cols-4 gap-12 mb-16">
                ...
                <div>
                    ...
                    <ul class="space-y-4 text-gray-400 text-sm">
                        <li class="flex items-start gap-3"><i class="fas fa-map-marker-alt text-fuchsia-500 mt-1"></i><span> Pakistan <img src="https://flagcdn.com/pk.svg" alt="PK" class="w-6 h-4 inline-block ml-1 align-middle rounded-sm"></span></li>
                           <li class="flex items-start gap-3"><i class="fas fa-user text-fuchsia-500 mt-1"></i><span>Managing Director : Haider Ali</span></li>
                        ...
                        <li class="flex items-center gap-3"><i class="fas fa-envelope text-fuchsia-500"></i><span>haiderzafar055@gmail.com</span></li>
                    </ul>
                </div>
            ...
            <div class="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center text-gray-500 text-sm">
                <p>&copy; 2025 Fitness Force Pro. All Rights Reserved.</p>
